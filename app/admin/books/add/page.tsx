                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className={getInputClass('title')} placeholder="Örn: Nutuk"
                            />
                        ...
                        <div>
                            ...
                            <select
                                name="authorId" value={form.authorId} onChange={handleChange}
                                className={`${getInputClass('authorId')} bg-white`}
                            >
                            ...
                            <div
                                ...
                                className="mt-1 text-xs text-amber-700 cursor-pointer hover:underline font-medium inline-block"
                            >
                                + Yeni Yazar Ekle
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                name="publisherId" value={form.publisherId} onChange={handleChange}
                                className={`${getInputClass('publisherId')} bg-white`}
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value={form.pageCount} onChange={handleChange}
                                min="1"
                                className={getInputClass('pageCount')} placeholder="350"
                            />
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`${getInputClass('language')} bg-white`}
                            >
                        ...
                        {form.addCopy && (
                            <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4 animate-in fade-in slide-in-from-top-2">
                                ...
                                <div>
                                    ...
                                    <select
                                        name="shelfId" value={form.shelfId} onChange={handleChange}
                                        disabled={!form.roomId || loadingShelves}
                                        className={`${getInputClass('shelfId')} disabled:bg-gray-100`}
                                    >
                    ...
                    <div className="pt-4 flex items-center justify-end gap-4 border-t border-stone-100">
                        ...
                        <button
                            ...
                            className="bg-amber-900 hover:bg-amber-800 text-white px-8 py-2.5 rounded-md font-serif font-medium shadow-md transition-all transform active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed"
                        >
